// describe('pages/tabBar/forum/forum.nvue', () => {
//     let page
//     beforeAll(async () => {
//         // 重新reLaunch至首页，并获取首页page对象（其中 program 是uni-automator自动注入的全局对象）
//         page = await program.reLaunch('/pages/tabBar/forum/forum')
...
//         expect((await program.navigateBack()).path).toBe('pages/tabBar/forum/forum')
//     })
